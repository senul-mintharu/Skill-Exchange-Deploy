...
public class ServiceRequestService {
  ...
  @Transactional
  public RequestResponse updateRequestStatus(Long requestId, Long seekerId, RequestStatusUpdateRequest requestData) {
    ServiceRequest request = serviceRequestRepository.findById(requestId)
        .orElseThrow(() -> new NotFoundException("Service request not found"));
    ...
    if (requestData.getStatus() != RequestStatus.COMPLETED) {
  ...
  private RequestResponse mapToResponse(ServiceRequest request) {
    ...
    if (assignedWorkerId != null) {
      assignedWorkerProfileId = workerProfileRepository.findByUserId(assignedWorkerId)
